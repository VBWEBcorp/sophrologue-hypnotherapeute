...
export function PremiumHero({
  ...
  // ── Variante avec image de fond (comme la page d'accueil) ────────────────
  if (backgroundImage) {
    return (
      <section className="relative isolate overflow-hidden">
        ...
        {/* Voile olive dégradé pour la lisibilité */}
        <div
          className="absolute inset-0 -z-10"
          aria-hidden
          style={{
            background:
              'linear-gradient(180deg, oklch(0.18 0.01 110 / 0.80) 0%, oklch(0.18 0.01 110 / 0.66) 55%, oklch(0.16 0.01 110 / 0.86) 100%)',
          }}
        />
        ...
        <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            ...
            className="flex flex-col items-center pt-12 pb-20 text-center sm:pt-14 sm:pb-24 lg:pt-16 lg:pb-28"
          >
            ...
            <h1 className="mt-6 max-w-3xl font-display text-balance text-4xl leading-[1.06] tracking-[-0.02em] text-white sm:text-5xl lg:text-[3.5rem]">
              {lead ? (
                <>
                  {lead}{' '}
