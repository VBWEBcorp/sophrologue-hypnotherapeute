      ...
      <div className="mx-auto max-w-6xl px-4 py-24 sm:px-6 sm:py-28 lg:px-8 lg:py-32">
        <div className="grid items-center gap-14 lg:grid-cols-2 lg:gap-20">
          ...
          >
            ...
            <div className="absolute -left-5 -top-6 hidden aspect-square w-32 overflow-hidden rounded-2xl bg-secondary shadow-[var(--shadow-md)] ring-4 ring-[oklch(0.913_0.024_80)] dark:ring-[oklch(0.215_0.027_305)] sm:block lg:w-36">
              <Image src={small1} alt="" fill sizes="160px" className="object-cover" />
            </div>
            {/* Petite photo bas-droite */}
            <div className="absolute -bottom-6 -right-5 hidden aspect-square w-32 overflow-hidden rounded-2xl bg-secondary shadow-[var(--shadow-md)] ring-4 ring-[oklch(0.913_0.024_80)] dark:ring-[oklch(0.215_0.027_305)] sm:block lg:w-36">
