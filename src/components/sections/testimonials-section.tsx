...
function MarqueeRow({
  ...
  return (
    <div className="group relative flex gap-6 overflow-hidden">
      <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-12 bg-gradient-to-r from-[oklch(0.965_0.013_85)] to-transparent dark:from-[oklch(0.245_0.015_112)] sm:w-24" />
      <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-12 bg-gradient-to-l from-[oklch(0.965_0.013_85)] to-transparent dark:from-[oklch(0.245_0.015_112)] sm:w-24" />
...
export function TestimonialsSection() {
  ...
  return (
    <section className="overflow-hidden border-y border-border/60 bg-[oklch(0.965_0.013_85)] dark:bg-[oklch(0.245_0.015_112)]">
